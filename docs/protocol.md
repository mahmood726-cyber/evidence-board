        # Evidence Board: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/evidence-board.git

        ## Objective

        Evidence Board is a meta-analysis research tool for evidence synthesis.
        ...
        - Code: https://github.com/mahmood726-cyber/evidence-board.git
        - Dashboard: https://mahmood726-cyber.github.io/evidence-board/
